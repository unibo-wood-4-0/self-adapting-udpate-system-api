 ...
 */
object OsCommandStringSuccessSerializer : KSerializer<OsCommand> {
    @Serializable
    ...
    override fun deserialize(decoder: Decoder): OsCommand =
        delegateSerializer.deserialize(decoder).let { internal ->
            OsCommand(internal.command.split(" "), Success(internal.success))
        }
    ...
    override fun serialize(
        ...
        delegateSerializer.serialize(
            encoder,
            InternalOsCommand(value.asSingleString(), successStrategy.success),
        )
    }
}
